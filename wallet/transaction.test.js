...
describe('Transaction',()=>{
    ...
    describe('outputMap',()=>{
        ...
        it('outputs the remaining amount in the `senderWallet`',()=>{
        ...
        describe('when the transaction is invalid',()=>{
            describe('and the transaction outputMap value is invalid',()=>{
                it('return false and logs an error',()=>{
                    transaction.outputMap[senderWallet.publicKey]=1234567;
    ...
    describe('update()',()=>{
        let originalSignature,nextAmount,originalSenderOutput,nextRecipient;
